...
if($this->startResultCache(false, array(($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()), $bUSER_HAVE_ACCESS, $arNavigation, $arrFilter, $pagerParameters)))
{
	 ...
	 */
	$arResult["GENERAL_REQ_LIST"];
	$geninfo = $fixer->GetElements(array(), array("IBLOCK_ID"=>"11", "ACTIVE"=>"Y"), $arGroupBy = false, $arNavStartParams = false, $arSelect = array("IBLOCK_ID", "ID", "PROPERTY_GENERAL_REQ_LIST"));
	$arResult["GENERAL_REQ_LIST"] = $geninfo[0]["~PROPERTY_GENERAL_REQ_LIST_VALUE"]["TEXT"];
