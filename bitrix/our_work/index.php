...
<?$APPLICATION->IncludeComponent("bitrix:catalog", "our_work", Array(
	"ACTION_VARIABLE" => "",	// Название переменной, в которой передается действие
		...
		"SEARCH_PAGE_RESULT_COUNT" => "",	// Количество результатов на странице
		...
		"SEF_FOLDER" => "/our_work/",	// Каталог ЧПУ (относительно корня сайта)
